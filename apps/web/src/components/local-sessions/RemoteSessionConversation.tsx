...
interface RemoteSessionConversationProps {
  ...
  readonly onDelete?: (sessionId: string, title: string) => void;
}

export function RemoteSessionConversation({ sessionId, onDelete }: RemoteSessionConversationProps) {
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2">
              ...
              {onDelete && (
                <button
                  type="button"
                  onClick={() => onDelete(sessionId, session.title)}
