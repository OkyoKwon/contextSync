  ...
  if (hasProject && !hasSessions) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <h2 className="text-lg font-semibold text-text-primary">Sync your first session</h2>
        <p className="mt-2 max-w-md text-center text-sm text-text-tertiary">
          Your project is ready! Head to the Conversations page to sync your Claude Code sessions
