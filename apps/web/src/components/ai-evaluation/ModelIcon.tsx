...
/** Anthropic (Claude) official logo — source: simple-icons */
...
/** OpenAI (ChatGPT) official logo — source: svgrepo / OpenAI brand */
...
/** Google Gemini official logo — source: simple-icons */
